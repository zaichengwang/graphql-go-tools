...
func TestResolvable_WithTracingNotStarted(t *testing.T) {
	...
	assert.JSONEq(t, `{
		"data": {"hello":"world"},
		"traceExtensions":{"trace":{"node_type":"object","nullable":true,"fields":[{"name":"hello","value":{"node_type":"string","path":["hello"]}}]}}
	}`, out.String())
}
